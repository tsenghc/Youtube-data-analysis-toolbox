...
Revision ID: 7faf1c6d44dc
Revises: 
Create Date: 2020-09-27 17:21:01.763137
...
def upgrade():
    ...
    op.create_index(op.f('ix_channel_playlist_items_video_id'), 'channel_playlist_items', ['video_id'], unique=True)
    ...
    sa.Column('live_broadcast_content', sa.String(), nullable=True),
    sa.Column('update_time', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['video_id'], ['channel_playlist_items.video_id'], ),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade():
    ...
    op.drop_index(op.f('ix_channel_playlist_items_video_id'), table_name='channel_playlist_items')
